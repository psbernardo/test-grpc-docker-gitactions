...
var file_proto_userpb_user_proto_rawDesc = []byte{
	...
	0x62, 0x22, 0x37, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	...
	,
...
var file_proto_userpb_user_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_proto_userpb_user_proto_depIdxs = []int32{
	0, // 0: userpb.UserService.UserTestCall:input_type -> userpb.User
	1, // 1: userpb.UserService.UserTestCall:output_type -> userpb.UserResponse
...
type UserServiceClient interface {
	UserTestCall(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) UserTestCall(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, "/userpb.UserService/UserTestCall", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	UserTestCall(context.Context, *User) (*UserResponse, error)
}
...
func (*UnimplementedUserServiceServer) UserTestCall(context.Context, *User) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UserTestCall not implemented")
}
...
func _UserService_UserTestCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(User)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).UserTestCall(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/userpb.UserService/UserTestCall",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UserTestCall(ctx, req.(*User))
	}
...
var _UserService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "UserTestCall",
			Handler:    _UserService_UserTestCall_Handler,
		},
	},
